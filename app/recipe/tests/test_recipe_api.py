...
class PrivateIngredientApiTest(TestCase):
    ...
    def test_recipes_limited_to_user(self):
        ...
        sample_recipe(user=self.user, title='Other recipe')
    ...
    def test_partial_update_recipe(self):
        ...
        recipe = sample_recipe(user=self.user)
        recipe.tags.add(sample_tag(user=self.user))
        new_tag = sample_tag(user=self.user, name='Tag changed')
...
class RecipeImageUploadTest(TestCase):
    ...
    def test_filter_recipes_by_tag(self):
        ...
        recipe_1 = sample_recipe(user=self.user,
                                 title='Thai vegetable curry')
        recipe_2 = sample_recipe(user=self.user, title='Aubergine with tahini',
                                 time_minutes=22, price=15.00)
        recipe_3 = sample_recipe(user=self.user, title='Fish & Ships',
                                 time_minutes=15, price=7.00)
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        ingredient_1 = sample_ingredient(user=self.user, name='Lettuce')
        ingredient_2 = sample_ingredient(user=self.user, name='Avocado')
